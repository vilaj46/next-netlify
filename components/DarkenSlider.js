...
export default function DarkenSlider({
  src,
  mainText,
  secondaryText,
  linkText,
  ...
  return (
    <div
      className="darkenSlider group flex justify-center mb-32 w-full 
                 h-min overflow-hidden h-40 text-center relative"
    >
      <Darken />
      <CenterMainText text={mainText} />
      <CenterSecondaryText text={secondaryText} linkText={linkText} />
...
function CenterSecondaryText({ text, linkText }) {
  return (
    <div
